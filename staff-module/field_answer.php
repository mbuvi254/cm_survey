			...
			<div class="card card-primary">
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						<h3 class="card-title"><b>Survey Details</b></h3><br>
			...
			<div class="card card-primary">
				...
				<div class="card-footer">
					<div class="d-flex w-100 justify-content-center">
						...
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'index.php?page=user_list'">Cancel</button>
					</div>
				</div>
			</div>
		</div>
...
<script>
	$('#manage-survey').submit(function(e){
		...
		start_load()
		$.ajax({
			url:'ajax.php?action=field_answer',
			method:'POST',
			data:$(this).serialize(),
