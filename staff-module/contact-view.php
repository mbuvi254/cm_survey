...
<input type="text" class="form-control" name="userName" id="userName"  value="<?php echo $_SESSION['staff_firstname']  .$_SESSION['staff_lastname'] ?>" />
</div>
<div class="input-row">
<label>Email</label>
<span id="userEmail-info" class="info"></span><br />
<input type="text" class="form-control" name="userEmail" id="userEmail" value="<?php echo $_SESSION['staff_email'] ?>" />
</div>
<div class="input-row">
<label>Subject</label>
