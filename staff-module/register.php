<?php
	...
	if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
		...
		mysqli_query($conn,"insert into staff (firstname,lastname,middlename,gender,contact,county,email, password, code) values ('$firstname','$lastname','$middlename','$gender','$contact','$county','$email', '$password', '$code')");
		...
		$to = $email;
			...
			$message = "
				...
				<h4><a href='https://www.staff.cybermaisha.co.ke/activate.php?uid=$uid&code=$code'>Activate My Account</h4>
				</body>
				</html>
				";
