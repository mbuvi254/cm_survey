<?php include'lib/dbh.php' ?>
   <!-- Main content -->
           ...
           <!-- BAR CHART -->
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Field User Report (<?php echo $year-1; ?> vs <?php echo $year; ?>)</h3>
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Field User List</h3>
                <div class="card-tools">
                	<button type="button" class="btn btn-tool" data-card-widget="collapse">
                    <i class="fas fa-minus"></i>
                  </button>
				...
				<a class="btn btn-tool btn-sm btn-primary btn-flat " href="./index.php?page=new_field_user"><i class="fa fa-plus"></i> Add New User</a>
			</div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
					...
					<tr>
						...
						<td class="text-center">
		                    ...
		                    <div class="dropdown-menu" style="">
		                      <a class="dropdown-item view_field_user" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">View</a>
    ...
    <!-- /.content -->
<?php include('field_userChart.php'); ?>
<script>
	...
	$('.view_field_user').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Field User Details","view_field_user.php?id="+$(this).attr('data-id'))
	})
	...
	function delete_user($id){
		start_load()
		$.ajax({
			url:'ajax.php?action=delete_field_user',
			method:'POST',
			data:{id:$id},
