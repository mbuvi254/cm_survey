		...
		<div class="card-body">
			<form action="" id="manage_user">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<b class="text-muted">System Data</b>
						<div class="form-group">
				...
				<div class="card-footer">
					...
					<button class="btn btn-secondary btn-flat btn-block" type="button" onclick="location.href = 'index.php?page=user_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
