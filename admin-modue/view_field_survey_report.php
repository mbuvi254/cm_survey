...
$taken = $conn->query("SELECT distinct(user_id) from field_answers where survey_id ={$id}")->num_rows;
$answers = $conn->query("SELECT a.*,q.type from field_answers a inner join questions q on q.id = a.question_id where a.survey_id ={$id}");
$ans = array();
			...
			<div class="card  card-secondary">
				...
				<div class="card-body p-0 py-2">
					<div class="container-fluid">
						...
						<small class="lead"><?php echo $description; ?></small>
						<p class="text-success">Start: <b><?php echo date("M d, Y",strtotime($start_date)) ?></b></p>
						<p class="text-danger">End: <b><?php echo date("M d, Y",strtotime($end_date)) ?></b></p>
...
<script>
	...
	$('#print').click(function(){
		start_load()
		var nw = window.open("print_field_report.php?id=<?php echo $id ?>","_blank","width=800,height=600")
			nw.print()
			setTimeout(function(){
				nw.close()
				end_load()
